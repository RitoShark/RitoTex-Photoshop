...
#include "TexFormat.h"			// .tex format codes, TEX_HEADER, block math, DXGI<->tex maps
...
// .tex format codes, TEX_HEADER, block math and DXGI<->tex maps now live in TexFormat.h
...
public:
	...
	{ 
		...
		// Dithering options for BC1/BC3 compression
		bool				useDithering;
		bool				useUniformMetric;
	};
...
public:
	...
	//Conversion functions from Photoshop buffer to 8bit ready encoding buffer
